...
public sealed class Result : IActionableResult<Result>
{
    /// <inheritdoc />
    ...
    private static readonly Result FailedResult = new(Bytegix.Lib.ResultHandling.Error.Empty);
    ...
    public static Result<TValue> Fail<TValue>()  where TValue : notnull
    {
    ...
    public static Result<TValue> Fail<TValue>(string errorMessage)  where TValue : notnull
    {
        var error = new Error(errorMessage);
    ...
    public static Result<TValue> Fail<TValue>(string errorMessage, (string Key, object Value) metadata)  where TValue : notnull
    {
        var error = new Error(errorMessage, metadata);
        return Result<TValue>.Fail(error);
    }
    ...
    /// <typeparam name="TValue">The type of the value in the result.</typeparam>
    /// <returns>A new instance of <see cref="Result{TValue}" /> representing a failed result with the specified error message and metadata.</returns>
    public static Result<TValue> Fail<TValue>(string errorMessage, IDictionary<string, object> metadata)  where TValue : notnull
    {
        var error = new Error(errorMessage, metadata);
        return Result<TValue>.Fail(error);
    }
    ...
    public static Result<TValue> Fail<TValue>(IError error)  where TValue : notnull
    {
        return Result<TValue>.Fail(error);
    }
    ...
    public static Result<TValue> Fail<TValue>(IEnumerable<IError> errors)  where TValue : notnull
    {
