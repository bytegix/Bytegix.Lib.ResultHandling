...
namespace Bytegix.Lib.ResultHandling.Tests;
public class ResultTValueTests
{
    ...
    public void Fail_WithErrorMessageAndTupleMetadata_ShouldCreateFailedResultWithSingleError()
    {
        ...
        error.Metadata.Should().ContainSingle().Which.Should()
    ...
    public void Error_WhenResultIsSuccess_ShouldThrowException()
    {
        ...
        // Act & Assert
        result.Invoking(r => _ = r.Error).Should().Throw<InvalidOperationException>()
            .WithMessage("Result is successful. Error is not set.");
    }
